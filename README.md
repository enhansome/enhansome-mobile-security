...
* [Infer – A Static Analysis tool for Java, C, C++ and Objective-C](https://github.com/facebook/infer) ⭐ 15,704 | 🐛 206 | 🌐 OCaml | 📅 2026-09-10
* [Checkstyle – A tool for checking Java source code](https://github.com/checkstyle/checkstyle) ⭐ 9,571 | 🐛 755 | 🌐 Java | 📅 2026-09-11
* [Error Prone – Static Analysis Tool](https://github.com/google/error-prone) ⭐ 7,235 | 🐛 526 | 🌐 Java | 📅 2026-09-11
* [Smali/Baksmali – Assembler/Disassembler for the dex format](https://github.com/JesusFreke/smali) ⚠️ Archived
* [APK Leaks – Scanning APK file for URIs, endpoints & secrets](https://github.com/dwisiswant0/apkleaks) ⭐ 6,283 | 🐛 26 | 🌐 Python | 📅 2025-08-20
...
* [Soot – A Java Optimization Framework](https://github.com/Sable/soot) ⭐ 3,097 | 🐛 347 | 🌐 Java | 📅 2026-09-11
...
* [Radare2 - Unix-like reverse engineering framework and commandline tools](https://github.com/radareorg/radare2) ⭐ 24,778 | 🐛 827 | 🌐 C | 📅 2026-09-11
* [Mobile-Security-Framework MobSF](https://github.com/MobSF/Mobile-Security-Framework-MobSF) ⭐ 21,747 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-09
* [Runtime Mobile Security (RMS) - is a powerful web interface that helps you to manipulate Android and iOS Apps at Runtime](https://github.com/m0bilesecurity/RMS-Runtime-Mobile-Security) ⭐ 3,083 | 🐛 9 | 🌐 JavaScript | 📅 2026-09-03
...
* [OWASP-mstg](https://github.com/OWASP/owasp-mstg/tree/master/Crackmes) ⭐ 13,177 | 🐛 239 | 🌐 Python | 📅 2026-09-11
...
* [apk-mitm - a CLI application that prepares Android APK files for HTTPS inspection](https://github.com/shroudedcode/apk-mitm) ⭐ 5,107 | 🐛 83 | 🌐 TypeScript | 📅 2024-07-24
...
* [Andriller - is software utility with a collection of forensic tools for smartphones](https://github.com/den4uk/andriller) ⭐ 1,604 | 🐛 11 | 🌐 Python | 📅 2022-06-27
...
* [Reverse Engineering iOS Applications](https://github.com/ivRodriguezCA/RE-iOS-Apps) ⭐ 2,910 | 🐛 2 | 📅 2024-04-17
...
* [Frida](https://github.com/frida/frida/releases) ⭐ 21,890 | 🐛 1,962 | 🌐 Meson | 📅 2026-09-09
* [Objection - mobile exploration toolkit by Frida](https://github.com/sensepost/objection) ⭐ 9,380 | 🐛 57 | 🌐 Python | 📅 2026-07-23
...
* [iLEAPP - iOS Logs, Events, And Preferences Parser](https://github.com/abrignoni/iLEAPP) ⭐ 1,218 | 🐛 62 | 🌐 Python | 📅 2026-09-10
